  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        {/* Hero : photo + texte */}
        <div className="max-w-6xl w-full mx-auto px-6 pt-24 pb-12 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <div
              className="absolute -top-3 -left-3 w-4 h-4 rounded-full bg-primary/40 animate-float"
